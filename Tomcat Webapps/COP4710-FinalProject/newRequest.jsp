...
<body>
<div class="main">
	<p class="sign" align="center">New Request</p>
	<form action="/COP4710-FinalProject/createNewRequest" method="get">
		<table>
			<tr>
	...
	<%=message%>
	<div><a href="/COP4710-FinalProject/professor.jsp">Back </a></div>
</div>
</body>
</html>
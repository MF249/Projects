...
public class ViewRequestProf extends HttpServlet{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            preparedStatement = connection.prepareStatement("select * from book where semester = ? and username = ?", ResultSet.TYPE_SCROLL_SENSITIVE,

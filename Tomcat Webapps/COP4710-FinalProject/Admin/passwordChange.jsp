...
<div class="main">
	<p class="sign" align="center">Change Password</p>
		<form action="/COP4710-FinalProject/ChangePassword" method="post">
			<input type = "text" align="center" name = "username" autocomplete="off" class="un" autofocus placeholder = "Username" <%=username%> />
			<input type = "password" align="center" name = "currentPassword" autocomplete="off" class="pass" autofocus placeholder = "Current Password" <%=currentPassword%> />

			<input type = "password" align="center" name = "newPassword" autocomplete="off" class="un" autofocus placeholder = "New Password" <%=newPassword%> />
			<input type = "password" align="center" name = "reenter" autocomplete="off" class="pass" autofocus placeholder = "Reenter New Password" <%=reenter%> />

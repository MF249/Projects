...
<body>
<div class="main">
	<p class="sign" align="center">Individual Invite</p>
	<form action="/COP4710-FinalProject/IndvInvite" method="post">
		<table>
			<tr>
				<td>Enter the Professor's email:</td>
	...
	<a href="/COP4710-FinalProject/Admin/admin.jsp">Back </a>
</div>
